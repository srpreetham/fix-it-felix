<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO user ( `u_email`, `u_password`, `u_name`, `u_phone`) VALUES ('$email', '$password', '$name', '$phone');";
 ...
 <?php include("templates/header_plain.php") ?>
 	<section class="container white-text">
 		<form class="white" action="user_register.php" method="POST" enctype="multipart/form-data">
