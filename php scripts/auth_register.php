<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO authority ( `a_email`, `a_password`, `a_name`, `a_phone`) VALUES ('$email', '$password', '$name', '$phone');";
 ...
 <?php include("templates/header_plain.php") ?>
 	<section class="container white-text">
 		<form class="white" action="auth_register.php" method="POST" enctype="multipart/form-data">
