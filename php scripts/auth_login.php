<?php 
	...
	// make query and get result
		...
		if($account[0]['a_email']==$email && $account[0]['a_password']==$password){
				echo "Access granted";
				header("location: authority.php?email=$email");
			}
 ...
 <?php include("templates/header_home.php") ?>
 	<section class="container white-text">
 		<form class="white" action="auth_login.php" method="POST" enctype="multipart/form-data">
