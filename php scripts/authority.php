...
<div class="container">
	<label class="white-text"><h5>Name: <?php echo htmlspecialchars($name) ?></h5></label><br>
	<label class="white-text"><h5>Email: <?php echo htmlspecialchars($email) ?></h5></label><br>
	<label class="white-text"><h5>Phone Number: <?php echo htmlspecialchars($phone) ?></h5></label><br>
	<label class="white-text"><h5>Id: <?php echo htmlspecialchars($id) ?></h5></label><br>
</div>
